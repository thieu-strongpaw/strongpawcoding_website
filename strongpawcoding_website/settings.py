"""
Django settings for strongpawcoding_website project.
...
ROOT_URLCONF = 'strongpawcoding_website.urls'
...
WSGI_APPLICATION = 'strongpawcoding_website.wsgi.application'
